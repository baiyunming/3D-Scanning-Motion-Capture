...
struct SurfaceCostFunction
{
	...
	{
		// TODO: Implement the cost function
		residual[0] = point.z-(pow(point.x,2)/(a[0]) - pow(point.y, 2)/(b[0]))/(c[0]);
		return true;
	}
...
int main(int argc, char** argv)
{
	...
	// const std::string file_path = "F:/TUM Learning Material/20WS/Informatik/3D Scanning & Motion Capture/exercise_4/exercise_4_src/data/points_surface.txt";
