...
void debugCorrespondenceMatching() {
	...
	const std::string filenameSource = std::string("F:/TUM Learning Material/20WS/Informatik/3D Scanning & Motion Capture/exercise_5/exercise_5_src/data/bunny/bunny_part2_trans.off");
	const std::string filenameTarget = std::string("F:/TUM Learning Material/20WS/Informatik/3D Scanning & Motion Capture/exercise_5/exercise_5_src/data/bunny/bunny_part1.off");
...
int reconstructRoom() {
	std::string filenameIn = std::string("F:/TUM Learning Material/20WS/Informatik/3D Scanning & Motion Capture/exercise_5/exercise_5_src/data/rgbd_dataset_freiburg1_xyz/");
