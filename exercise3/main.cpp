...
int alignBunnyWithProcrustes() {
	...
	const std::string filenameSource = std::string("F:/TUM Learning Material/20WS/Informatik/3D Scanning & Motion Capture/exercise_3/exercise_3_src/data/bunny/bunny_trans.off");
	const std::string filenameTarget = std::string("F:/TUM Learning Material/20WS/Informatik/3D Scanning & Motion Capture/exercise_3/exercise_3_src/data/bunny/bunny.off");
	...
	resultingMesh.writeMesh(std::string("F:/TUM Learning Material/20WS/Informatik/3D Scanning & Motion Capture/exercise_3/exercise_3_bin/bunny_procrustes.off"));
